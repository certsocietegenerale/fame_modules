...
class Joe(ProcessingModule):
    ...
    config = [
        {"name": "apikey", "type": "str", "description": "API Key to use to connect to your account."},
        {
            "name": "wait_timeout",
            "type": "integer",
            "default": 5400,
    ...
    def extract_threatname(self, report):
        ...
        for prefix, event, value in parser:
            if (
                prefix == "analysis.signaturedetections.strategy.item.threatname"
